...
const FetchHttpOptions = importFile("http-backends/fetch-http-options");

describe("fetch http options tests", function () {
  it("test to json", function () {
    let options = new FetchHttpOptions({});
